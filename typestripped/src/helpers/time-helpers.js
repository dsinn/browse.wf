...
export function localDateToUtcDayTimestamp(date) {
...
export function getNextWeeklyResetSeconds() {
...
export function formattz(offsetMinutes) {
    if (offsetMinutes === 0) {
        return 'UTC+0';
    }
