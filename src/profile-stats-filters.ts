...
(window as any).EQUIPMENT_CATEGORIES = EQUIPMENT_CATEGORIES;
(window as any).ENEMY_FACTIONS = ENEMY_FACTIONS;
(window as any).getEquipmentCategoryLabel = getEquipmentCategoryLabel;
(window as any).getEnemyFactionLabel = getEnemyFactionLabel;
(window as any).initStatsFilterBar = initStatsFilterBar;
