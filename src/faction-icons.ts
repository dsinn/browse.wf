...
export const FACTION_ICON_PATHS: Record<TFaction, string> = {
 ...
 */
export const ENEMY_FACTION_TO_TFACTION: Record<string, TFaction> = {
	Corpus: 'FC_CORPUS',
	Duviri: 'FC_DUVIRI',
	Grineer: 'FC_GRINEER',
...
export function getFactionIconPath(faction: string): string | undefined {
