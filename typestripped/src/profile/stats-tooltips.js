 ...
 */
export function addTimeStatTooltip(elm, stat, value) {
 ...
 */
export function addStatPercentage(stat, value) {
 ...
 */
export function addCipherAvgTooltip(elm, profile) {
...
//# sourceMappingURL=stats-tooltips.js.map