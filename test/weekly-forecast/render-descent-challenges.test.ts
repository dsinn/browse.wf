...
describe('renderDescentChallenges', () => {
  ...
  test('renders one row per challenge (21 rows)', () => {
    const descent = worldState.Descents[0];
    const tbody = renderDescentChallenges(descent, dict) as HTMLTableSectionElement;
  ...
  test('unknown arenas fall back to plain text', () => {
    ...
    const tbody = renderDescentChallenges(unknownDescent, {}) as HTMLTableSectionElement;
  ...
  test('falls back to raw path tail when dict key is missing', () => {
    ...
    const descent = worldState.Descents[0];
    const tbody = renderDescentChallenges(descent, {}) as HTMLTableSectionElement;
