...
test.describe('Live Page - Bounties Card', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await expect(page.locator('#bounties-body')).not.toContainText('Fetching data...', { timeout: 10000 });
  });
  ...
  test.describe('Bounty Checkboxes', () => {
    test.beforeEach(async ({ page }) => {
      await page.waitForSelector('#EntratiLabSyndicate-name .completion-check', { timeout: 10000 });
    });
