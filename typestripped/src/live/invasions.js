...
export function calculatePercentage(wsInvasion) {
    let progress = 1 - Math.abs(wsInvasion.Count / wsInvasion.Goal);
    progress = Math.max(0, progress);
    progress = Math.min(1, progress);
    return progress * 100;
}
export function createInvasionProgressBar(wsInvasion, percentage) {
...
export function isInvasionRewardShown(itemType) {
...
const pendingActivationTimeouts = new Map();
...
//# sourceMappingURL=invasions.js.map