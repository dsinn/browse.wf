...
let invigorationNames = {};
export function initInvigorations(names) {
...
export function populateInvigorationGrid(prefix, response, suits) {
...
export function preFillForm(username, peek, suits) {
...
export function saveToCache(request, response) {
...
export function showHistory(currentWeek, cache) {
...
export function showResults(response, request) {
...
export function initInvigorationTimer() {
...
export function scheduleInvigorationReload() {
    const weekEnd = getNextWeeklyResetSeconds();
    setTimeout(() => {
        location.reload();
    }, (weekEnd * 1000) - Date.now());
}
export function showCacheAlert(type, message) {
...
export function initInvigorationsFromCache(inventoryDataUsed) {
...
//# sourceMappingURL=invigorations.js.map