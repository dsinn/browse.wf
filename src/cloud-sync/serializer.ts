 ...
 */
export function flattenObject(object: Record<string, any>, prefix = ''): Record<string, any> {
 ...
 */
export function localStorageToData(): Record<string, any> {
 ...
 */
export function dataToLocalStorage(data: Record<string, any>): void {
